 ...
 *
 * The agent runner (`runAgent` in agent-runtime) is mocked so the test is
...
import { buildDag, executeDag, getDag, registerDag, resetDagRegistry } from '../../src/services/agent-dag';
import {
  buildGraphAnalysis,
  detectDeadlocks,
  resolveDeadlocks,
  suggestBreakpoints,
} from '../../src/services/deadlock-detector';
import { applyMergeStrategies } from '../../src/services/merge-strategies';
