...
export const SandboxConfigSchema = z.object({
  ...
  maxOutputBytes: z.number().int().positive().default(1 << 20),
...
export const PluginManifestSchema = z.object({
  ...
  name: z.string().min(3).max(200).regex(/^[a-z0-9][a-z0-9._-]*$/i),
...
export const EXAMPLE_MANIFEST: PluginManifest = {
  ...
  sandbox: { allowNetwork: false, allowFilesystem: false, allowEnv: false, maxFuel: 50_000_000, maxWallMs: 10_000, maxOutputBytes: 1 << 20 },
